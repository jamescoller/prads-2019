...
plt.ylim(0, 1)
plt.grid()
plt.savefig('output/case_study_1_rev.png',format='png')
...
plt.ylim(0, 1)
plt.grid()
plt.savefig('output/case_study_2_rev.png',format='png')
...
plt.ylim(0, 1)
plt.grid()
plt.savefig('output/case_study_6_rev.png',format='png')
